...
// COMMENTED OUT: Setup token flow — no keychain needed
...
// COMMENTED OUT: Setup token flow — no credentials file needed
...
// COMMENTED OUT: Setup token flow — use setup-token instead
...
// COMMENTED OUT: Setup token flow — no credentials to clear
...
// COMMENTED OUT: Setup token flow — setup tokens don't expire, no refresh needed
